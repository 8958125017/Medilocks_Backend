...
MailSchema.statics = {
    sendPasswordMail: function (req, password, cb) {
        ...
        obj.msg = 'Hi  &nbsp;&nbsp;'+ req.firstName + ',<br><br>'+
            'You are receiving this because you have successfully registered for medi logs.<br><br>' +
    ...
    resetPwdMail: function (req, token, cb) {
        ...
        console.log('signup:',req);
        console.log("===========================");
        obj.msg = 'You are receiving this jjjj because you (or someone else) has requested a reset of your account password.<br/>' +
            'Please click on the following link, or paste into your browser to complete the process:<br/>' +
            '<a href="' + CONST.hostingServer.serverUiName+'updatepassword/' + token + '" target="_blank" >' + CONST.hostingServer.serverUiName+'updatepassword/' + token + '</a><br><br>';
